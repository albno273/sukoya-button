import * as vtubers from '~/constraints/vtubers';
import { YouTubeVideo } from '~/types';

const tulip = [vtubers.shellin, vtubers.hayase];
const crossick = [vtubers.tomoe];
...
export const sukoyaSongs: Array<YouTubeVideo> = [
  ...
  },
  {
    ...
    coStars: [vtubers.ruri],
    date: '2021-01-01',
  },
  {
    videoId: '-_9gCnAQzP4',
    song: {
      title: 'KING -DJ WILDPARTY remix-',
      isOriginal: false,
      artist: 'Kanaria feat. GUMI',
      lyricist: 'Kanaria',
      composer: 'Kanaria',
      remixed: 'DJ WILDPARTY',
    },
    date: '2020-12-31',
  },
  {
